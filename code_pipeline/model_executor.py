...
class ModelExecutor(AbstractTestExecutor):
    ...
    def _run_simulation(self, the_test) -> SimulationData:
        ...
        # lidar = Lidar()
        # self.vehicle.attach_sensor('lidar', lidar)
        ...
        camera = (self.driver_camera_name, Camera((-0.3, 2.1, 1), (0, 1, 0), 90, (600, 600)))
    ...
    def get_driver_camera_image(self):
        ...
        # TODO: maybe convert to opencv format and feed model with image
        img.show()
        return img
