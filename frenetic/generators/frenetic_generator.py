...
from frenetic.generators.base_frenet_generator import BaseFrenetGenerator
...
class CustomFrenetGenerator(BaseFrenetGenerator):
    ...
    def __init__(self, executor=None, map_size=None, kill_ancestors=1, strict_father=True,
                 ...
                 segment_length=10, min_oob_distance_threshold=-0.5, store_additional_data=False):
    ...
    def generate_initial_population(self):
        ...
        while self.executor.time_budget.get_remaining_real_time() > (time_budget - self.random_gen_budget):
            log.info("Random generation. Remaining time %s", self.get_remaining_time())
