...
def post_process(ctx, result_folder, the_executor):
    ...
    feature_maps.feature_maps.create_folder("map", "../../tool-competition-av/results/")
    ...
    feature_maps.feature_maps.create_feature_maps(ctx, True, True, tag, "../../tool-competition-av/results/map")
