# taken from https://github.com/udacity/self-driving-car/blob/master/steering-models/community-models/autumn/autumn/cnn_model.py
...
class ConvModel(object):
    ...
    def __init__(self, dropout_prob=0.2, batch_norm=False, whitening=False, is_training=True):
        ...
        y = tf.multiply(tf.atan(tf.matmul(self.h_fc4_drop, self.W_fc5) + self.b_fc5), 2, name='y')
