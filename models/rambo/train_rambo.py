...
from models.rambo.config import TrainConfig
import os
...
if __name__ == "__main__":
    ...
    # use last frames from all parts as validation set
        ...
        X_train = np.concatenate((X_train1[:3800], X_train2[:13500], X_train3[:1680], X_train4[:3600], X_train5[:6300]),
                                 axis=0)
        y_train = np.concatenate((y_train1[:3800], y_train2[:13500], y_train3[:1680], y_train4[:3600], y_train5[:6300]),
                                 axis=0)
        X_test = np.concatenate((X_train1[3800:], X_train2[13500:], X_train3[1680:], X_train4[3600:], X_train5[6300:]),
                                axis=0)
        y_test = np.concatenate((y_train1[3800:], y_train2[13500:], y_train3[1680:], y_train4[3600:], y_train5[6300:]),
                                axis=0)
    ...
    if config.model_name == "comma_prelu":
